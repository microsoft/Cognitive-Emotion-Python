...
This [Jupyter Notebook](<http://jupyter.org/>) demonstrates how to use Python with the Microsoft Emotion API, part of [Cognitive Services](https://www.microsoft.com/cognitive-services).
